...
INSERT INTO auth_schema.email_otps (
    ...
    (1001, 'khachhang.chinh@laundry.vn', '$2a$10$iYGwq/z2LBYxTd92vFkTieFp8ZUrE.PHapoOqFETmA6tAAZCOXyfS', 'EMAIL_LOGIN', NOW() + INTERVAL '10 minutes', FALSE, NOW()),
    (1002, 'quantri.hethong@laundry.vn', '$2a$10$iYGwq/z2LBYxTd92vFkTieFp8ZUrE.PHapoOqFETmA6tAAZCOXyfS', 'ADMIN_2FA', NOW() + INTERVAL '10 minutes', FALSE, NOW())
ON CONFLICT (id) DO UPDATE SET
    email = EXCLUDED.email,
...
INSERT INTO locker_schema.locker_boxes (
    ...
    (1001, 1001, 1, 'SMALL', TRUE, 'Ô tủ nhỏ gọn', 'AVAILABLE', NOW() - INTERVAL '14 days', NOW()),
    ...
    (1006, 1003, 1, 'MEDIUM', FALSE, 'Ô tủ đang tạm ngưng phục vụ', 'MAINTENANCE', NOW() - INTERVAL '10 days', NOW())
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO locker_schema.locker_reports (
    ...
    (1001, 1003, 1002, 'Cảnh báo cảm biến cửa', 'Tủ khóa bảo trì báo lỗi cảm biến mở cửa', 'OPEN', NULL, NULL, NOW() - INTERVAL '3 days', NOW()),
    (1002, 1001, 1001, 'Vấn đề độ sáng màn hình', 'Độ sáng màn hình giảm vào ban đêm', 'RESOLVED', 1002, NOW() - INTERVAL '1 day', NOW() - INTERVAL '2 days', NOW())
ON CONFLICT (id) DO UPDATE SET
    locker_id = EXCLUDED.locker_id,
...
INSERT INTO order_schema.orders (
    ...
    (1001, 'ORD-SEED-1001', 1001, 1001, '0901001001', 'Nguyễn Khách', 1001, 1002, 1003, 1001, 1002, 'LAUNDRY', 'LAUNDRY', 'PROCESSING', 3.50, 'kg', 10000, 50000, 15000, 0, 25000, 122500, 172500, 'CHAO20', 'CHAO20,MIENSHIP', '482913', NOW() - INTERVAL '8 days', NULL, NOW() + INTERVAL '1 day', NULL, NULL, NOW() + INTERVAL '3 days', 'Đơn giặt sấy kèm dịch vụ siêu tốc', 'Xin hãy giặt cẩn thận áo sơ mi công sở', 'Đã nhận đồ và bắt đầu phân loại', NULL, '12 Nguyễn Huệ, Quận 1', NOW() - INTERVAL '8 days', NOW()),
    (1002, 'ORD-SEED-1002', 1005, 1005, '0901001005', 'Phạm Thành', 1002, 1005, NULL, 1002, 1002, 'LAUNDRY', 'HOUSEHOLD', 'COMPLETED', 1.00, 'item', 0, 0, 0, 0, 0, 120000, 120000, NULL, NULL, '771204', NOW() - INTERVAL '7 days', NOW() - INTERVAL '5 days', NOW() - INTERVAL '4 days', NOW() - INTERVAL '3 days', NULL, NOW() - INTERVAL '2 days', 'Đơn vệ sinh chăn mền lớn', 'Gọi trước khi giao hàng', 'Đã giao hàng thành công', NULL, '45 Điện Biên Phủ, Quận Bình Thạnh', NOW() - INTERVAL '7 days', NOW()),
    (1003, 'ORD-SEED-1003', 1001, 1001, '0901001001', 'Nguyễn Khách', 1001, 1001, NULL, 1001, NULL, 'LAUNDRY', 'DRY_CLEANING', 'INITIALIZED', NULL, 'kg', 0, 0, 15000, 0, 0, 60000, 60000, NULL, NULL, '193847', NOW(), NULL, NOW() + INTERVAL '2 days', NULL, NULL, NOW() + INTERVAL '4 days', 'Đơn giặt hấp áo sơ mi', 'Không ủi hồ nhé', NULL, NULL, NULL, NOW(), NOW()),
    (1004, 'ORD-SEED-1004', 1005, 1005, '0901001005', 'Phạm Thành', 1003, 1006, NULL, 1003, NULL, 'LAUNDRY', 'PACKAGE', 'CANCELED', NULL, 'month', 0, 0, 0, 0, 0, 499000, 499000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Gói dịch vụ tháng bị hủy trước khi bắt đầu', 'Tôi thay đổi lịch trình', 'Hủy theo yêu cầu của khách hàng', 1, NULL, NOW() - INTERVAL '2 days', NOW())
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO order_schema.order_details (
    ...
    (1001, 1001, 1001, 3.50, 122500, 'Giặt sấy tiêu chuẩn 3.5 kg'),
    ...
    (1005, 1004, 1005, 1.00, 499000, 'Đăng ký gói giặt sấy tháng')
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO order_schema.order_status_history (
    ...
    (1001, 1001, NULL, 'INITIALIZED', 1001, 'Khách hàng khởi tạo đơn hàng', NOW() - INTERVAL '8 days'),
    ...
    (1004, 1002, 'PROCESSING', 'COMPLETED', 1002, 'Đơn hàng đã hoàn thành và giao thành công', NOW() - INTERVAL '3 days'),
    (1005, 1003, NULL, 'INITIALIZED', 1001, 'Đơn hàng giặt hấp mới', NOW()),
    (1006, 1004, 'INITIALIZED', 'CANCELED', 1005, 'Khách hàng hủy đăng ký gói', NOW() - INTERVAL '2 days')
ON CONFLICT (id) DO UPDATE SET
    order_id = EXCLUDED.order_id,
...
INSERT INTO order_schema.order_ratings (
    ...
    (1001, 1002, 1005, 5, 'Dịch vụ nhanh chóng và quần áo rất sạch sẽ', NOW() - INTERVAL '2 days'),
    (1002, 1001, 1001, 4, 'Chất lượng tốt, nhưng đang chờ thông báo lấy đồ', NOW() - INTERVAL '1 day')
ON CONFLICT (id) DO UPDATE SET
    order_id = EXCLUDED.order_id,
    user_id = EXCLUDED.user_id,
...
INSERT INTO order_schema.order_complaints (
    ...
    (1001, 1001, 1001, 'DELAY', 'Khách hàng hỏi thời gian nhận đồ', 'OPEN', NOW() - INTERVAL '1 day'),
    (1002, 1002, 1005, 'OTHER', 'Khách hàng yêu cầu xuất hóa đơn', 'RESOLVED', NOW() - INTERVAL '2 days')
ON CONFLICT (id) DO UPDATE SET
    order_id = EXCLUDED.order_id,
    user_id = EXCLUDED.user_id,
    type = EXCLUDED.type,
...
INSERT INTO payment_schema.refunds (
    ...
    (1001, 1004, 1004, 499000, 'COMPLETED', 'Đơn hàng bị hủy trước khi bắt đầu', 'REF-SEED-1004', 1004, NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 day')
ON CONFLICT (id) DO UPDATE SET
...
\echo 'Vietnamese real data seed completed'
