...
Khi đồ giặt xong (`READY`), Staff dùng mã RETURN (do Partner tạo ở UC3 bước 3) để mở tủ locker, bỏ đồ sạch vào. Hệ thống
tự động cập nhật trạng thái, đánh dấu box `OCCUPIED`, và sinh mã PIN mới cho khách đến lấy.

**Actor chính:** Staff (actor ngoài)
**Enum sử dụng:
** [OrderStatus](file:///d:/BigProject/laundry-locker-backend/laundry-locker-backend/src/main/java/com/huynqb/laundrylockerbackend/module/order/service/OrderService.java#317-329), [BoxStatus](file:///d:/BigProject/laundry-locker-backend/laundry-locker-backend/src/main/java/com/huynqb/laundrylockerbackend/module/iot/service/IoTService.java#167-187),
...
> [!IMPORTANT]
> Sau bước này, khách có **24 giờ** để đến lấy đồ. Nếu quá hạn,
> scheduler [sendPickupReminders()](file:///d:/BigProject/laundry-locker-backend/laundry-locker-backend/src/main/java/com/huynqb/laundrylockerbackend/core/scheduler/OrderSchedulerService.java#199-238)
> gửi notification nhắc nhở mỗi giờ, và khi lấy đồ sẽ bị tính **phí quá hạn**.
