...
Landing page sử dụng 241 frame images với hiệu ứng **auto-play video-like** - mỗi section tự động phát như một video
ngắn khi vào viewport, sau đó người dùng có thể scroll để kiểm soát.
