...
> **Mô tả:** Tài liệu chi tiết toàn bộ API mà Staff (nhân viên bên ngoài của Partner) sử dụng, bao gồm cả Staff có tài
> khoản hệ thống và Staff không có tài khoản (chỉ dùng Access Code/OTP).
