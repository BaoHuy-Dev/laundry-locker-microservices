...
VALUES
  (9001, 'baohuy2k12k4@gmail.com',             '0980000001', 'Bảo Huy',  'Quản trị viên',       DATE '1990-01-01', NULL, 'ACTIVE', 'ADMIN',       NOW(), NOW()),
  (9002, 'nqbhuy2004nt@gmail.com',             '0980000002', 'Quốc Bảo', 'Huy',         DATE '2004-04-04', NULL, 'ACTIVE', 'CUSTOMER',    NOW(), NOW()),
  (9003, 'se180211nguyenquocbaohuy@gmail.com', '0980000003', 'Bảo Huy',  'Bảo Trì',     DATE '1998-02-02', NULL, 'ACTIVE', 'MAINTENANCE', NOW(), NOW()),
  (9004, 'huynqbse180211@fpt.edu.vn',          '0980000004', 'Huy',      'Quản Lý',     DATE '1995-03-03', NULL, 'ACTIVE', 'MANAGER',     NOW(), NOW());
...
SELECT l, b,
       ...
       (b - 1) / 3, (b - 1) % 3,
       CASE WHEN (l + b) % 17 = 0 THEN 'Hỏng khóa điện tử' ELSE NULL END
...
SELECT 90000 + g,
       ...
       9002, 9002, '0980000002', 'Nguyễn Quốc Bảo Huy',
...
SELECT 90000 + g, 1 + (g % 5), 1 + (g % 3), (20000 + (g % 5) * 5000)::numeric,
       'Dịch vụ giặt sấy cho đơn ORD-HCM-' || lpad(g::text, 5, '0')
FROM generate_series(1, 100) AS g;
