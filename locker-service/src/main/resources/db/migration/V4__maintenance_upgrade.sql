...
ALTER TABLE locker_reports ADD COLUMN IF NOT EXISTS box_id BIGINT;
ALTER TABLE locker_reports ADD COLUMN IF NOT EXISTS assigned_to_user_id BIGINT;
ALTER TABLE locker_reports ADD COLUMN IF NOT EXISTS assigned_at TIMESTAMP;
